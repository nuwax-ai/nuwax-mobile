...
> **已废弃（仅保留历史排查用途）**：Android、iOS、HarmonyOS 新包请使用 [App 原生支付接入说明](../integration/app-native-pay-integration.md)，走 `/api/bill/order/pay/app-native` 和微信 `WXLaunchMiniProgram`，不要继续接入本文的 `/pay/h5-web` 跳转方案。
