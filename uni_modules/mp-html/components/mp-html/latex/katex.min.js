...
const y = (r) =>
    "data:image/svg+xml," + encodeURIComponent(r.replace(/\s+/g, " ")),
  x = (r, t, e) => {
    let n = !1;
  ...
  u = (r, t) =>
    r
      .map((e) => {
        var s;
        let n = t;
        (s = e == null ? void 0 : e.style) != null &&
          s.color &&
          (n = e.style.color);
        let i;
        e instanceof l.__domTree.Span && (i = "span"),
          e instanceof l.__domTree.Anchor && (i = "anchor"),
          e instanceof l.__domTree.LineNode && (i = "line"),
          e instanceof l.__domTree.PathNode && (i = "path"),
          e instanceof l.__domTree.SvgNode &&
            ((i = "svg"), n && (e.attributes.fill = n)),
          e instanceof l.__domTree.SymbolNode && (i = "text");
        const a = e.children && e.children.length > 0 ? u(e.children, n) : [];
        return i ? x(i, e, a) : a;
      })
      .filter((e) => !!e)
      .reduce(
        (e, n) => (n ? (Array.isArray(n) ? [...e, ...n] : [...e, n]) : [...e]),
        []
      )
      .filter((e) => !!e),
  _ = (r, t = {}) => {
  ...
  w = function (r, t, e) {
    ...
    for (; n < t.length; ) {
      const s = t[n];
      if (i <= 0 && t.slice(n, n + a) === r) return n;
      s === "\\" ? n++ : s === "{" ? i++ : s === "}" && i--, n++;
    }
    return -1;
  },
  ...
  T = function (r, t) {
    let e;
    const n = [],
      i = new RegExp("(" + t.map((a) => k(a.left)).join("|") + ")");
    for (; (e = r.search(i)), e !== -1; ) {
      ...
      if (((e = w(t[a].right, r, t[a].left.length)), e === -1)) break;
      const s = r.slice(0, e + t[a].right.length),
        f = E.test(s) ? s : r.slice(t[a].left.length, e);
      n.push({
        type: "math",
        data: f,
        rawData: s,
  ...
  P = function (r, t) {
    ...
    if (e.length === 1 && e[0].type === "text") return e[0].data;
    const n = [];
    for (let a = 0; a < e.length; a++)
      if (e[a].type === "text")
        ...
        try {
          ...
          if (!(c instanceof l.ParseError)) throw c;
          (i = t.errorCallback) == null ||
            i.call(
              t,
