...
#
# 仓外统一目录（本机）：
#   NUWAX_OFFLINE_SDK_HOME = /Users/apple/workspace/nuwax-mobile-offline-sdk
...
export NUWAX_WORKSPACE_ROOT="${NUWAX_WORKSPACE_ROOT:-/Users/apple/workspace}"
...
export NUWAX_BUNDLE_ID="${NUWAX_BUNDLE_ID:-com.nuwax.nuwa}"
...
export DCLOUD_APPKEY="${DCLOUD_APPKEY:-02c109ded799bad828c3183534b330e3}"
